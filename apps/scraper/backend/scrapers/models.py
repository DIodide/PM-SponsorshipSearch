...
class SponsorInfo:
    ...
    asset_type: Optional[str] = None  # e.g., "Jersey Patch", "Naming Rights", "Official Partner"
...
class TeamRow:
    ...
    def has_enrichment(self, enricher_name: str) -> bool:
        ...
        return self.enrichments_applied is not None and enricher_name in self.enrichments_applied
...
METRIC_GROUPS = {
    ...
    "social": {
        ...
        "fields": [
            "followers_x", "followers_instagram", "followers_facebook", 
            "followers_tiktok", "subscribers_youtube", "avg_game_attendance"
        ],
        "icon": "users",
    },
    "family": {
